...
Write_Title("# npm install -g npm-upgrade express express-session express-generator ejs mysql2")
npm install -g npm-upgrade express express-session express-generator ejs mysql2
br(1)
