...
:copy_Linux
xcopy %owl-playbook_LINUX% %LINUX% /ES
exit /b

:copy_Windows
xcopy %owl-playbook_WINDOWS%\go %WINDOWS%\go /ES
xcopy %owl-playbook_WINDOWS%\npm %WINDOWS%\npm /ES
xcopy %owl-playbook_WINDOWS%\ubuntu %WINDOWS%\ubuntu /ES
...
:copy_linux_MNT
xcopy %owl-playbook_LINUX_MNT% %LINUX_MNT% /ES
exit /b
